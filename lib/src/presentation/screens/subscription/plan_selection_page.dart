...
import 'package:foodam/src/domain/entities/dish_entity.dart' as domain;
...
class _PlanSelectionPageState extends State<PlanSelectionPage> {
  domain.SubscriptionDuration _selectedDuration = domain.SubscriptionDuration.sevenDays;
  domain.DietaryPreference _selectedPreference = domain.DietaryPreference.vegetarian;
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          ...
          runSpacing: 8,
          children: [
            _buildDurationChip(domain.SubscriptionDuration.sevenDays, '7 Days'),
            _buildDurationChip(domain.SubscriptionDuration.fourteenDays, '14 Days'),
            _buildDurationChip(domain.SubscriptionDuration.twentyEightDays, '28 Days'),
          ],
        ),
      ],
    );
  ...
  Widget _buildDurationChip(domain.SubscriptionDuration duration, String label) {
  ...
  Widget _buildPreferenceOption(
      domain.DietaryPreference preference, String label, IconData icon) {
    final isSelected = _selectedPreference == preference;
    final color = preference == DietaryPreference.vegetarian
  ...
  Widget _buildPlanCard(domain.Subscription plan) {
  ...
  void _showDraftFoundDialog(BuildContext context, domain.Subscription draftSubscription) {
    showDialog(
      context: context,
  ...
  String _getDurationText(domain.SubscriptionDuration duration) {
    switch (duration) {
      case domain.SubscriptionDuration.sevenDays:
        return '7 Days';
      case domain.SubscriptionDuration.fourteenDays:
        return '14 Days';
      case domain.SubscriptionDuration.twentyEightDays:
        return '28 Days';
      case domain.SubscriptionDuration.monthly:
        return 'Monthly';
      case domain.SubscriptionDuration.quarterly:
        return 'Quarterly';
      case domain.SubscriptionDuration.halfYearly:
        return 'Half Yearly';
      case domain.SubscriptionDuration.yearly:
        return 'Yearly';
      case domain.SubscriptionDuration.days30:
        // TODO: Handle this case.
        throw UnimplementedError();
    }
  }

  int _getDurationInDays(domain.SubscriptionDuration duration) {
    switch (duration) {
      case domain.SubscriptionDuration.sevenDays:
